...
ENV FLINK_TGZ_URL=https://www.apache.org/dyn/closer.cgi?action=download&filename=flink/flink-1.13.0/flink-1.13.0-bin-scala_2.12.tgz \
...
COPY ./flink-azure-fs-hadoop-1.13.0.jar ./plugins/azure-fs-hadoop/
